"""
20/12/2020 11:00:00
@author shivam.g,subhrojyoti,priyanshu,niharika
"""
                            ...
                            if st.checkbox("Begin S3 Download"):
                                if not selected_account:
                                    ...
                                    if choosen_gdrive_data.shape[0]==len(selected_account):
                                        ...
                                        analysed_month = root_dir+"/"+selected_month + "_"+ selected_year
                                        ...
                                        if st.button(label="Start Downloading S3 path from DB"):
                                            ...
                                            for env, group_env in assigned_accounts_group_environment:
                                                ...
                                                for server_port_number, group_env in server_grouped:
                                                    st.write(
                                                        f" Establishing Connection with Destination Server Port {str(server_port_number)} and Source Port {str(group_env['local_port'].tolist()[0])} in execution")
                                                    ...
                                                    ##Function call for Downloading S3
